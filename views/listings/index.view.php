                ...
                <?php foreach ($listings as $listing) :  ?>
                    ...
                    <div class="rounded-lg shadow-md bg-white">
                        <div class="p-4">
                            ...
                            <a href="<?=$listing->id ?>" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200"
                            >
                                Details
                            </a>
                        </div>
